...
- [x] 1. Install dependencies and remove SQLite packages
  - [x] 1.1 Add Neon and fast-check dependencies, remove libsql
...
- [x] 2. Migrate schema from SQLite to PostgreSQL dialect
  - [x] 2.1 Convert schema module to use pgTableCreator and PostgreSQL column types
  ...
  - [x] 2.2 Write property test for table name prefix preservation
...
- [x] 3. Replace database driver with Neon serverless
  - [x] 3.1 Rewrite database client module to use Neon HTTP adapter
...
- [x] 4. Update environment variable schema and configuration
  - [x] 4.1 Update env schema to validate PostgreSQL connection strings
  ...
  - [x] 4.2 Update Drizzle config to use PostgreSQL dialect and unpooled URL
  ...
  - [x] 4.3 Update .env.example with Neon placeholder values
  ...
  - [x] 4.4 Write property test for connection string validation
...
- [x] 5. Checkpoint - Ensure build and type checks pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Update build pipeline and test configuration
  - [x] 6.1 Update build script to run migrations before next build
  ...
  - [x] 6.2 Update Vitest config with PostgreSQL-format test env vars
...
- [x] 7. Remove SQLite artifacts and update gitignore
  - [x] 7.1 Remove SQLite database file and update .gitignore
...
- [x] 8. Generate initial PostgreSQL migration
  - [x] 8.1 Generate Drizzle migration for the PostgreSQL schema
