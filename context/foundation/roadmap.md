...
- **S-23: user can tap "Why this?" on the next-task suggestion card and see a calm, deterministic breakdown of factors (energy fit, interruptions, cycles completed, time of day, last override) — without leaving the wedge overlay or opening analytics.** — Archived 2026-06-10 → `context/archive/2026-06-10-suggestion-rationale-expander/` ([PR #89](https://github.com/konrad-kaluzny-ceneo/FlowState/pull/89)). Lesson: exclude headline factor from expander; hide control when breakdown empty.
