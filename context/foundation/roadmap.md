...
| F-06 | serene-pastel-rebrand                  | [FLO-62](https://linear.app/flowstate-10xdev/issue/FLO-62) | [#97](https://github.com/konrad-kaluzny-ceneo/FlowState/issues/97)          | (foundation) `DESIGN.md` + token pivot to Serene Pastel Well-being light-default; remap home, overlays, task cards, auth; optional calm dark sub-phase                         | F-04, S-13       | Secondary Success Criteria, NFR (200ms acknowledgement), proposed-FR-visual-design-system                                         | active   |
