...
- **Accessible wedge overlay gates (P-102 / roadmap-expand 2026-06-12)** — **Promoted 2026-06-26** to **S-39 accessible-wedge-gates** after S-21/S-28/F-07 landed; includes screen-reader focus/live-region coverage on wedge gates.
- **Wedge keyboard shortcuts (P-103 / research gap)** — **Promoted 2026-06-26** into **S-39 accessible-wedge-gates** as the keyboard-first accept/override/start phase; do not split before the gate accessibility baseline.
- **Session reconnect calm banner (P-104 / research gap)** — Why parked: NFR connection-loss recovery exists but no UX surface; lightweight banner slice candidate. Expand score 61/90 — **park**. **Batch 7 (2026-06-26):** remains parked — not absorbed into S-40/S-42; separate future recovery candidate.
- **Post-merge wedge activation coach (P-106 / roadmap-expand 2026-06-12)** — **Promoted 2026-06-18** to active **S-11 ext.** (Stream N′ Phase 4, after F-07). Event storming hot-1. See [`flow-coherence-recommendations.md`](flow-coherence-recommendations.md) and [`items/S-11.md`](items/S-11.md).
