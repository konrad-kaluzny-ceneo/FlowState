...
- [ ] 2.1 `pnpm exec vitest run src/server/api/routers/task-mutation.test.ts` passes
- [ ] 2.2 `pnpm exec vitest run src/server/api/routers/task-isolation.test.ts` passes
- [ ] 2.3 `pnpm test` passes
- [ ] 2.4 `pnpm typecheck` passes
