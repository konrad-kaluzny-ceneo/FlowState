...
- [ ] 2.6 Hero and rail illustration visibly change tint/pose across idle → energy_choice → work → break → return → closure in a live authenticated session
...
- [ ] 4.1 New E2E spec passes: `pnpm exec playwright test e2e/stateful-illustration.spec.ts`
- [ ] 4.2 Accessibility scan passes: `pnpm test:e2e:a11y`
- [ ] 4.3 Full belt suite still passes: `pnpm test:e2e:belt`
