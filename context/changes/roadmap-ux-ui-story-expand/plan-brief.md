...
| ID allocation | F-14, S-40, S-41, S-42, S-43 | No collision with S-39 / Q-09 terminus | Research |
| `main_goal` frontmatter | Keep `quality` until F-14 ships | Avoid relabeling before first slice lands; new Stream R carries the chapter | Plan |
| Commit order | F-14 → S-40 → S-41 → S-42 → S-43 | Voice + IA before desktop; recap after hierarchy; illustrations after rail slot defined | Research / batch-7 |
...
| Issue pairs | Create Linear/GitHub for F-14 + S-40–S-43 after roadmap accept | Product/foundation slices; unlike Q-08/Q-09 quality companions | Plan / L-01 |
...
- Add `items/F-14.md`, `items/S-40.md` … `items/S-43.md`
...
| 2. Patch roadmap index | F-14 + S-40–S-43 in `roadmap.md` | Wrong prerequisite chain breaks sequencing |
...
| 5. Handoff | Status sync + first downstream `/10x-plan` target | Starting with S-40 before F-14 weakens copy contract |
...
- Polish-first copy in F-14 may temporarily coexist with English UI until child slices land.
