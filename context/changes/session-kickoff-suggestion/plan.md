...
- [x] 1.1 `pnpm prisma migrate dev` applies cleanly — 87aaa6d
- [x] 1.2 `pnpm check` passes — 87aaa6d
- [x] 1.3 `pnpm typecheck` passes — 87aaa6d
- [x] 1.4 `pnpm exec vitest run src/server/api/routers/suggestion.test.ts src/server/api/routers/suggestion-isolation.test.ts` passes — 87aaa6d
...
- [x] 3.1 `pnpm check` passes — 9ad14a6
- [x] 3.2 `pnpm exec vitest run src/hooks/use-pomodoro-cycle.test.tsx` passes (kickoff UI/override cases) — 9ad14a6
...
- [x] 5.1 `pnpm check` passes — e10e76e
- [x] 5.2 `pnpm test` passes — e10e76e
- [x] 5.3 `set CI=true && pnpm test:e2e e2e/session-kickoff.spec.ts` passes — e10e76e
- [x] 5.4 `set CI=true && pnpm test:e2e e2e/task-suggestion.spec.ts` passes (regression) — e10e76e
