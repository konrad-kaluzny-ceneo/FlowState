...
- [ ] 2.1 Unit/integration tests pass: `pnpm exec vitest run src/server/api/routers/preference.test.ts`
- [ ] 2.2 Full test suite passes: `pnpm test`
- [ ] 2.3 Typecheck passes: `pnpm typecheck`
- [ ] 2.4 Lint passes: `pnpm check`
...
- [ ] 4.1 Audio tests pass: `pnpm exec vitest run src/lib/audio.test.ts`
- [ ] 4.2 Hook tests pass: `pnpm exec vitest run src/hooks/use-pomodoro-cycle.test.tsx`
- [ ] 4.3 Full test suite passes: `pnpm test`
- [ ] 4.4 Typecheck passes: `pnpm typecheck`
- [ ] 4.5 Lint passes: `pnpm check`
...
- [ ] 6.1 Full test suite passes: `pnpm test`
- [ ] 6.2 Typecheck passes: `pnpm typecheck`
...
- [ ] 7.1 Tab pulse tests pass: `pnpm exec vitest run src/lib/cycle-end-tab-pulse.test.ts`
- [ ] 7.2 Full test suite passes: `pnpm test`
- [ ] 7.3 Typecheck passes: `pnpm typecheck`
- [ ] 7.4 Lint passes: `pnpm check`
