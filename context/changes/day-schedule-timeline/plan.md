...
- [ ] 5.1 `pnpm check`, `pnpm typecheck`, `pnpm test` pass
- [ ] 5.2 `set CI=true && pnpm test:e2e:belt` pass

#### Manual

- [ ] 5.3 Full auth manual walkthrough; budget and delegation regression check
